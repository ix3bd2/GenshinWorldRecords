 ...
 */
final class Version20220319185316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO buff (id, character_id, weapon_id, artifact_id, img, description) SELECT id, character_id, weapon_id, aritfact_id, img, description FROM __temp__buff');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO buff (id, character_id, weapon_id, aritfact_id, img, description) SELECT id, character_id, weapon_id, artifact_id, img, description FROM __temp__buff');
        $this->addSql('DROP TABLE __temp__buff');
        $this->addSql('CREATE INDEX IDX_752742631136BE75 ON buff (character_id)');
        $this->addSql('CREATE INDEX IDX_7527426395B82273 ON buff (weapon_id)');
