 ...
 */
final class Version20220225202915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artifact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, img CLOB DEFAULT NULL COLLATE BINARY, halfset VARCHAR(255) DEFAULT NULL COLLATE BINARY, fullset CLOB DEFAULT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__artifact AS SELECT id, name, img, halfset, fullset FROM artifact');
        $this->addSql('DROP TABLE artifact');
        $this->addSql('CREATE TABLE artifact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, img CLOB DEFAULT NULL, halfset VARCHAR(255) DEFAULT NULL, fullset CLOB DEFAULT NULL, character_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO artifact (id, name, img, halfset, fullset) SELECT id, name, img, halfset, fullset FROM __temp__artifact');
        $this->addSql('DROP TABLE __temp__artifact');
