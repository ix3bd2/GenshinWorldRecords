 ...
 */
final class Version20220110211756 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        , img CLOB DEFAULT NULL COLLATE BINARY, banner CLOB DEFAULT NULL COLLATE BINARY, banner_bg CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO character (id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, artifact) SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, artifact FROM __temp__character');
        $this->addSql('DROP TABLE __temp__character');
        $this->addSql('CREATE INDEX IDX_937AB03495B82273 ON character (weapon_id)');
        $this->addSql('CREATE INDEX IDX_937AB0341F1F2A24 ON character (element_id)');
