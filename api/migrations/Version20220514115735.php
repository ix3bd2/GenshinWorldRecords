 ...
 */
final class Version20220514115735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons, active FROM character');
        ...
        , nation VARCHAR(255) DEFAULT NULL COLLATE BINARY, aaimg CLOB DEFAULT NULL COLLATE BINARY, talent_eimg CLOB DEFAULT NULL COLLATE BINARY, talent_qimg CLOB DEFAULT NULL COLLATE BINARY, cons INTEGER DEFAULT NULL, active INTEGER DEFAULT NULL, player_name VARCHAR(255) DEFAULT NULL, ar VARCHAR(255) DEFAULT NULL, abyss_clear VARCHAR(255) DEFAULT NULL, main_char VARCHAR(255) DEFAULT NULL, highest_dmg INTEGER DEFAULT NULL, CONSTRAINT FK_937AB03495B82273 FOREIGN KEY (weapon_id) REFERENCES weapon (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_937AB0341F1F2A24 FOREIGN KEY (element_id) REFERENCES element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO character (id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons, active) SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons, active FROM __temp__character');
        ...
        $this->addSql('CREATE TABLE team (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, weapon_id INTEGER DEFAULT NULL, character_id INTEGER DEFAULT NULL, element_id INTEGER DEFAULT NULL, atk INTEGER DEFAULT NULL, def INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, er DOUBLE PRECISION DEFAULT NULL, em INTEGER DEFAULT NULL, cr DOUBLE PRECISION DEFAULT NULL, cd DOUBLE PRECISION DEFAULT NULL, ed DOUBLE PRECISION DEFAULT NULL, talent_e INTEGER DEFAULT NULL, talent_q INTEGER DEFAULT NULL, talent_aa INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, aaimg CLOB DEFAULT NULL COLLATE BINARY, talent_eimg CLOB DEFAULT NULL COLLATE BINARY, talent_qimg CLOB DEFAULT NULL COLLATE BINARY, cons INTEGER DEFAULT NULL, rarity INTEGER DEFAULT NULL, CONSTRAINT FK_C4E0A61F95B82273 FOREIGN KEY (weapon_id) REFERENCES weapon (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C4E0A61F1136BE75 FOREIGN KEY (character_id) REFERENCES character (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C4E0A61F1F1F2A24 FOREIGN KEY (element_id) REFERENCES element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , nation VARCHAR(255) DEFAULT NULL, aaimg CLOB DEFAULT NULL, talent_eimg CLOB DEFAULT NULL, talent_qimg CLOB DEFAULT NULL, cons INTEGER DEFAULT NULL, active INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO character (id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons, active) SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons, active FROM __temp__character');
        $this->addSql('DROP TABLE __temp__character');
        $this->addSql('CREATE INDEX IDX_937AB03495B82273 ON character (weapon_id)');
        $this->addSql('CREATE INDEX IDX_937AB0341F1F2A24 ON character (element_id)');
