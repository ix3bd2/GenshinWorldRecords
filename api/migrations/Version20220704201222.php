 ...
 */
final class Version20220704201222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EBFAB36E7AD42B48');
        $this->addSql('DROP INDEX IDX_EBFAB36E1136BE75');
        $this->addSql('DROP INDEX IDX_EBFAB36E95B82273');
        $this->addSql('CREATE TEMPORARY TABLE __temp__spiral_abyss_teams AS SELECT id, weapon_id, character_id, top3_spiral_abyss_id, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, cons FROM spiral_abyss_teams');
        $this->addSql('DROP TABLE spiral_abyss_teams');
        $this->addSql('CREATE TABLE spiral_abyss_teams (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, weapon_id INTEGER DEFAULT NULL, character_id INTEGER DEFAULT NULL, top3_spiral_abyss_id INTEGER DEFAULT NULL, atk INTEGER DEFAULT NULL, def INTEGER DEFAULT NULL, hp INTEGER DEFAULT NULL, er DOUBLE PRECISION DEFAULT NULL, em INTEGER DEFAULT NULL, cr DOUBLE PRECISION DEFAULT NULL, cd DOUBLE PRECISION DEFAULT NULL, ed DOUBLE PRECISION DEFAULT NULL, talent_e INTEGER DEFAULT NULL, talent_q INTEGER DEFAULT NULL, talent_aa INTEGER DEFAULT NULL, cons INTEGER DEFAULT NULL, half INTEGER DEFAULT NULL, CONSTRAINT FK_EBFAB36E95B82273 FOREIGN KEY (weapon_id) REFERENCES weapon (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EBFAB36E1136BE75 FOREIGN KEY (character_id) REFERENCES character (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EBFAB36E7AD42B48 FOREIGN KEY (top3_spiral_abyss_id) REFERENCES top3_spiral_abyss (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO spiral_abyss_teams (id, weapon_id, character_id, top3_spiral_abyss_id, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, cons) SELECT id, weapon_id, character_id, top3_spiral_abyss_id, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, cons FROM __temp__spiral_abyss_teams');
        $this->addSql('DROP TABLE __temp__spiral_abyss_teams');
        ...
        $this->addSql('DROP INDEX IDX_167020E8E28B07AC');
        $this->addSql('DROP INDEX IDX_167020E8B688C588');
        $this->addSql('CREATE TEMPORARY TABLE __temp__spiral_abyss_teams_artifact AS SELECT spiral_abyss_teams_id, artifact_id FROM spiral_abyss_teams_artifact');
        $this->addSql('DROP TABLE spiral_abyss_teams_artifact');
        $this->addSql('CREATE TABLE spiral_abyss_teams_artifact (spiral_abyss_teams_id INTEGER NOT NULL, artifact_id INTEGER NOT NULL, PRIMARY KEY(spiral_abyss_teams_id, artifact_id), CONSTRAINT FK_167020E8B688C588 FOREIGN KEY (spiral_abyss_teams_id) REFERENCES spiral_abyss_teams (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_167020E8E28B07AC FOREIGN KEY (artifact_id) REFERENCES artifact (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO spiral_abyss_teams_artifact (spiral_abyss_teams_id, artifact_id) SELECT spiral_abyss_teams_id, artifact_id FROM __temp__spiral_abyss_teams_artifact');
        $this->addSql('DROP TABLE __temp__spiral_abyss_teams_artifact');
