 ...
 */
final class Version20220218100153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__artifact AS SELECT id, name, img, halfset, fullset FROM artifact');
        $this->addSql('DROP TABLE artifact');
        $this->addSql('CREATE TABLE artifact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, character_id INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, img CLOB DEFAULT NULL COLLATE BINARY, halfset VARCHAR(255) DEFAULT NULL COLLATE BINARY, fullset CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_48E5602C1136BE75 FOREIGN KEY (character_id) REFERENCES character (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO artifact (id, name, img, halfset, fullset) SELECT id, name, img, halfset, fullset FROM __temp__artifact');
        $this->addSql('DROP TABLE __temp__artifact');
        $this->addSql('CREATE INDEX IDX_48E5602C1136BE75 ON artifact (character_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_48E5602C1136BE75');
        $this->addSql('CREATE TEMPORARY TABLE __temp__artifact AS SELECT id, name, img, halfset, fullset FROM artifact');
        $this->addSql('DROP TABLE artifact');
        $this->addSql('CREATE TABLE artifact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, img CLOB DEFAULT NULL, halfset VARCHAR(255) DEFAULT NULL, fullset CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO artifact (id, name, img, halfset, fullset) SELECT id, name, img, halfset, fullset FROM __temp__artifact');
        $this->addSql('DROP TABLE __temp__artifact');
        $this->addSql('DROP INDEX IDX_752742631136BE75');
        $this->addSql('DROP INDEX IDX_7527426395B82273');
        ...
        , nation VARCHAR(255) DEFAULT NULL, aaimg CLOB DEFAULT NULL, talent_eimg CLOB DEFAULT NULL, talent_qimg CLOB DEFAULT NULL, cons INTEGER DEFAULT NULL, artifact CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:array)
        )');
        $this->addSql('INSERT INTO character (id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons) SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, nation, aaimg, talent_eimg, talent_qimg, cons FROM __temp__character');
        $this->addSql('DROP TABLE __temp__character');
        $this->addSql('CREATE INDEX IDX_937AB03495B82273 ON character (weapon_id)');
