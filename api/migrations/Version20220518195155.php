 ...
 */
final class Version20220518195155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE latest_social (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tweets CLOB DEFAULT NULL --(DC2Type:array)
        , youtube_video CLOB DEFAULT NULL)');
        ...
        , nation VARCHAR(255) DEFAULT NULL COLLATE BINARY, aaimg CLOB DEFAULT NULL COLLATE BINARY, talent_eimg CLOB DEFAULT NULL COLLATE BINARY, talent_qimg CLOB DEFAULT NULL COLLATE BINARY, cons INTEGER DEFAULT NULL, active INTEGER DEFAULT NULL, player_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, ar VARCHAR(255) DEFAULT NULL COLLATE BINARY, abyss_clear VARCHAR(255) DEFAULT NULL COLLATE BINARY, main_char VARCHAR(255) DEFAULT NULL COLLATE BINARY, highest_dmg INTEGER DEFAULT NULL, CONSTRAINT FK_937AB03495B82273 FOREIGN KEY (weapon_id) REFERENCES weapon (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_937AB0341F1F2A24 FOREIGN KEY (element_id) REFERENCES element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE latest_social');
        $this->addSql('DROP INDEX IDX_752742631136BE75');
        $this->addSql('DROP INDEX IDX_7527426395B82273');
        $this->addSql('DROP INDEX IDX_75274263E28B07AC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__buff AS SELECT id, character_id, weapon_id, artifact_id, img, description FROM buff');
