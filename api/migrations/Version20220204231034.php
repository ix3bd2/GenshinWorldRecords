 ...
 */
final class Version20220204231034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , nation VARCHAR(255) DEFAULT NULL COLLATE BINARY, aaimg CLOB DEFAULT NULL COLLATE BINARY, talent_eimg CLOB DEFAULT NULL COLLATE BINARY, talent_qimg CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_937AB03495B82273 FOREIGN KEY (weapon_id) REFERENCES weapon (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_937AB0341F1F2A24 FOREIGN KEY (element_id) REFERENCES element (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
