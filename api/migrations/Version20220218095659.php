 ...
 */
final class Version20220218095659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE buff_character');
        $this->addSql('CREATE TEMPORARY TABLE __temp__buff AS SELECT id, img, description FROM buff');
        ...
        $this->addSql('INSERT INTO buff (id, img, description) SELECT id, img, description FROM __temp__buff');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__character AS SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, artifact, nation, aaimg, talent_eimg, talent_qimg, cons FROM character');
        ...
        $this->addSql('INSERT INTO character (id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, artifact, nation, aaimg, talent_eimg, talent_qimg, cons) SELECT id, weapon_id, element_id, name, atk, def, hp, er, em, cr, cd, ed, talent_e, talent_q, talent_aa, video_url, weapon_refine, rarity, buff, artifact, nation, aaimg, talent_eimg, talent_qimg, cons FROM __temp__character');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE buff_character (buff_id INTEGER NOT NULL, character_id INTEGER NOT NULL, PRIMARY KEY(buff_id, character_id))');
        $this->addSql('CREATE INDEX IDX_59B111181136BE75 ON buff_character (character_id)');
        $this->addSql('CREATE INDEX IDX_59B111184B9528D0 ON buff_character (buff_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__buff AS SELECT id, img, description FROM buff');
        $this->addSql('DROP TABLE buff');
        $this->addSql('CREATE TABLE buff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, img CLOB DEFAULT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO buff (id, img, description) SELECT id, img, description FROM __temp__buff');
        $this->addSql('DROP TABLE __temp__buff');
        $this->addSql('DROP INDEX IDX_937AB03495B82273');
        $this->addSql('DROP INDEX IDX_937AB0341F1F2A24');
