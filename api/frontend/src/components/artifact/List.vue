<template>
  <div>
    ...
    <table class="table table-responsive table-striped table-hover">
      ...
      <tbody>
        ...
        <td>
          ...
          <td>
            <router-link :to="{name: 'ArtifactUpdate', params: { id: item['@id'] }}">
              <span
                class="fa fa-pencil"
                aria-hidden="true"></span>
    ...
    <nav aria-label="Page navigation" v-if="view">
      <router-link
        :to="view['hydra:first'] ? view['hydra:first'] : 'ArtifactContactList'"
      ...
      &nbsp;
      <router-link
        :to="!view['hydra:previous'] || view['hydra:previous'] === view['hydra:first'] ? 'ArtifactList' : view['hydra:previous']"
        :class="{ disabled: !view['hydra:previous'] }"
        class="btn btn-primary">
