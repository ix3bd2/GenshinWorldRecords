...
import WeaponForm from './Form.vue';
...
export default {
  ...
  computed: {
    ...
    ...mapFields('weapon/create', {
      created: 'created',
    }),
    ...mapFields('weapon/update', {
      isLoading: 'isLoading',
      error: 'error',
      retrieved: 'retrieved',
      updated: 'updated',
  ...
  methods: {
    ...mapActions({
      createReset: 'weapon/create/reset',
      deleteItem: 'weapon/del/del',
      delReset: 'weapon/del/reset',
      retrieve: 'weapon/update/retrieve',
      updateReset: 'weapon/update/reset',
      update: 'weapon/update/update',
      updateRetrieved: 'weapon/update/updateRetrieved',
    }),
